package com.puc.tcc.deliverymaintainer.utils;
...
public class Util {
	...
	public static String getPagameterToken(String token, String tokenParameter) throws DeliveryMaintainerException {
		try {
			...
			throw new DeliveryMaintainerException(HttpStatus.INTERNAL_SERVER_ERROR, Constants.SERVER_ERROR);
		}
	}
